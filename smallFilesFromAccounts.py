...
path = path = 'C:/Users/Edu/Desktop/PMR/Q1 2022 PMR/FBN/'
bank = 'FBN'
cusID = []
...
smallCredInfo = smallerCreditInfo(path + '731777726665676499-Credit-Information-2022Mar31.txt',
                  path+'missing.txt')
...
smallIndBorro = smallerIndBorrower(path+'731777726665676499-Individual-Borrower-2022Mar31.txt',cusID)
# write to file
...
smallCorpBorro = smallerCorpBorrower(path+'731777726665676499-Corporate-Borrower-2022Mar31.txt',cusID)
# write to file
